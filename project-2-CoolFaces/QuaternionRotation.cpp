 ...
 * @date [2/14/26]
 * @brief This file contains the implementation of the QuaternionRotation class, 
...
* Sets type_ to "QUATERNION"
*/
QuaternionRotation::QuaternionRotation(double w, double x, double y, double z) : Rotation("QUATERNION"), w_(w), x_(x), y_(y), z_(z){}
