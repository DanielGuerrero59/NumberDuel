 ...
 * @date [2/14/26]
 * @brief This file contains the implementation of the EulerRotation class, 
...
* Sets type_ to "EULER"
*/
EulerRotation::EulerRotation(double roll, double pitch, double yaw) : Rotation("EULER"), roll_(roll), pitch_(pitch), yaw_(yaw) {}
